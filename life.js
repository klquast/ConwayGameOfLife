    ...
    _.prototype = {
        ...
        aliveNeighbors: function(array, x, y) {
            ...
            return [
                ...
                return prev + +!!cur; // convert to a number, works even if undefined
            }, 0);
        },
...
(function(){
    ...
    _.prototype = {
        createGrid: function(){
            ...
            var fragment = document.createDocumentFragment(); // Doesn't modify actual DOM until you append it, better for performance
            this.grid.innerHTML = '';
            this.checkboxes = [];
        ...
        get boardArray(){
            return this.checkboxes.map(function(row){
                return row.map(function(checkbox) {
                    return +checkbox.checked; // + in front converts it to a numb
                });
            });
        },
        ...
        next: function(){
            ...
            for (var y = 0; y < this.size; y++) {
                for (var x = 0; x < this.size; x++) {
                    this.checkboxes[y][x].checked = !!board[y][x]; //!! converts to boolean
                }
            }
